      ...
      <div className="relative flex h-full min-h-[inherit] items-end">
        <div className="mx-auto w-full max-w-7xl px-4 py-24 sm:px-6 sm:py-32">
          <ScrollReveal variant="up">
            {eyebrow ? (
              <p className="text-sm font-bold uppercase tracking-[0.2em] text-indigo-400">{eyebrow}</p>
            ) : null}
  ...
  return (
    <ScrollReveal variant="scale">
      <div className="gradient-border p-8 sm:p-10">
        ...
        <a href={to} className="mt-5 inline-flex text-sm font-semibold text-indigo-300 hover:text-white">
          {label} →
        </a>
      </div>
    </ScrollReveal>
