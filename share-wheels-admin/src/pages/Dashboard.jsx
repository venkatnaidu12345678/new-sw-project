  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3 overflow-hidden">
      <PageHeader
        ...
        subtitle="Real-time platform health — auto-refreshes every 15 seconds."
      >
      ...
      <div className="grid min-h-0 flex-1 grid-cols-12 grid-rows-6 gap-3">
        {/* Ride status donut */}
        <section className="col-span-12 row-span-2 flex flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm lg:col-span-4 lg:row-span-3">
        ...
        {/* 7-day activity */}
        <section className="col-span-12 row-span-2 flex flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm lg:col-span-5 lg:row-span-3">
        ...
        {/* Requests bar */}
        <section className="col-span-12 row-span-2 flex flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm lg:col-span-3 lg:row-span-3">
        ...
        {/* Recent rides table */}
        <section className="col-span-12 row-span-3 flex min-h-0 flex-col overflow-hidden lg:row-span-3">
